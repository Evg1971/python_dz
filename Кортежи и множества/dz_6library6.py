...
def find_book(title):
    ...
    if book_info:
        if book_info['available'] is None:
            print(f"Книга {title} в библиотеке, но ее статус не определен")
        elif book_info['available'] == "выдана":
            print(f"Книга {title} выдана")
        elif book_info['available'] == "в наличии":
